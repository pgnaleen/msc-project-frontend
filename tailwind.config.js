...
const customPalettes = {
    ...
    sis: generatePalette('#E0272A'),
};

// needed to add this again as otherwise there would be cyclic dependency
const theme = {
    colors: {
        gears: {
            50: '#FDF4F4',
...
const themes = {
    ...
    'default': {
        primary  : {
            ...theme.colors.gears,
            DEFAULT: theme.colors.gears[900]
        },
        accent   : {
            ...theme.colors.gears,
            DEFAULT: theme.colors.gears_red
        },
        warn     : {
            ...colors.red,
